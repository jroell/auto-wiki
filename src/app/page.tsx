...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://github.com/jroell/auto-wiki');

  const REPO_CONFIG_CACHE_KEY = 'autowikiRepoConfigCache';
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              >https://github.com/jroell/auto-wiki
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/jroell/auto-wiki" target="_blank" rel="noopener noreferrer"
